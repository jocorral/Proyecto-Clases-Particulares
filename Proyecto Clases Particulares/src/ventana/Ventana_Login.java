...
public class Ventana_Login extends JFrame{
	...
	private static void cargaInicialDeDatos(){
		...
		insertsYTablas.add("CREATE TABLE MENSAJE (COD NUMBER(5), ASUNTO VARCHAR(50), CONTENIDO VARCHAR(1000), FECHA DATE);");
		...
		insertsYTablas.add("CREATE TABLE ENVIA (COD_MENSAJE NUMBER(5), DNI_A NUMBER(8), DNI_P NUMBER(8), QUIEN_E VARCHAR(8));");
		...
		insertsYTablas.add("ENVIA '00000', '88888880', '77777770', 'ALUMNO';");
		insertsYTablas.add("ENVIA '00001', '88888881', '77777770', 'ALUMNO';");
		insertsYTablas.add("ENVIA '00002', '88888881', '77777770', 'ALUMNO';");
		insertsYTablas.add("ENVIA '00003', '88888880', '77777770', 'ALUMNO';");
